...
class VistaEditIncidents
{
    public static function editincidents($id)
    {
            ...
            <div>
                <div class='centered-content block'>
                    <form id='crear-prestamo' method='POST' action='index.php?accion=modificar_incidencia'>
                        ...
                        <textarea rows='4' cols='50' name='observaciones'>".$array[0][3]."</textarea>

                        <label>Soporte</label>
                        <textarea rows='4' cols='50' name='soporte'>".$array[0][4]."</textarea>

                        <input type='hidden' name='id' value='".$array[0][5]."'/>
